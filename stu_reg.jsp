...
<center><h1 style="color:#663300;"><u>Student Registration Form</u></h1></center>
<div style="margin-left:200px; margin-right:200px;">
<hr color="#990033" />

<center><table cellpadding="2px" style=" border-style:solid; font-size:15px;">
<form action=stu_db.jsp name=About>
<script language="javascript">
 ...
 <tr><th><h2>Personal Details</h2></th></tr>
	...
	Last Name</td><td><br><input type=text name=n2 spellcheck="false" placeholder="Last Name" > </td> </tr>
			<tr><td><b><br>Father's Name</b></td><td><br><input type=text name=n3 spellcheck="false" placeholder="Mr." required="required"></td></tr> 
					<tr><td><b><br>Roll no.</b></td><td><br><input type=text name=n4 spellcheck="false" placeholder="10 digits" required="required"></td></tr> 
...
<tr><td><hr /></td><td><hr /></td><td><hr /></td><td><hr /></td></tr>
 <tr><th><h2>Acount Details</h2></th></tr>
	...
	<tr><td><b><br>Username</b></td><td><br><input type=text name=n16 spellcheck="false" placeholder="User Name" required="required"></td></tr>
	<tr><td><b><br>Password</b></td><td><br><input type=password name=n17 spellcheck="false" placeholder="min 6 characters" required="required"></td>
