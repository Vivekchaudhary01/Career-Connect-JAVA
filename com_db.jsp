...
<ul>
   ...
   <li class='has-sub'><a href='#'><span>CDC</span></a>
      <ul>
         <li class='last'><a href=emp_reg.jsp><span>Registration</span></a></li>
...
String s22=request.getParameter("n22");
            ...
            ResultSet rs;
stmt.executeUpdate("INSERT into company(cname,usn,pwd,date,month,year,fno,bn,city,state,pin,en,cno,email,hfno,hbn,hcity,hstate,hpin,hen,hcno,hemail) values('"+s1+"','"+s22+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','"+s10+"','"+s11+"','"+s12+"','"+s13+"','"+s14+"','"+s15+"','"+s16+"','"+s17+"','"+s18+"','"+s19+"','"+s20+"','"+s21+"')");
stmt.executeUpdate("INSERT into login(usn,pwd,status,type) values('"+s22+"','"+s2+"','P','C')");
