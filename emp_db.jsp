...
String s18=request.getParameter("n18");
            ...
            ResultSet rs;
stmt.executeUpdate("INSERT into emp(fname,lname,usn,pwd,date,month,year,gender,hno,bn,city,state,pin,cno,email,qual,exp,des) values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','"+s10+"','"+s11+"','"+s12+"','"+s13+"','"+s14+"','"+s15+"','"+s16+"','"+s17+"','"+s18+"')");
stmt.executeUpdate("INSERT into login(usn,pwd,status,type) values('"+s3+"','"+s4+"','P','F')");
