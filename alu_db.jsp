...
String s4=request.getParameter("graduation_year");
String s5=request.getParameter("current_position");
String s6=request.getParameter("achievements");
String s7=request.getParameter("feedback");
String s8=request.getParameter("newsletter");
String s9=request.getParameter("magazine");
            ...
            ResultSet rs;
            stmt.executeUpdate("INSERT into alu_reg values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"')");
