...
String s17=request.getParameter("n17");
            ...
            ResultSet rs;
stmt.executeUpdate("INSERT into student(fname,lname,faname,rollno,date,month,year,gender,hno,bn,city,state,pin,cno,email,usn,pwd) values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','"+s10+"','"+s11+"','"+s12+"','"+s13+"','"+s14+"','"+s15+"','"+s16+"','"+s17+"')");
stmt.executeUpdate("INSERT into login(usn,pwd,status,type) values('"+s16+"','"+s17+"','P','S')");
