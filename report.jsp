...
<br><br><br><br>
<center>
<form action=report_db.jsp name=About>
<table cellpadding="2px" style=" border-style:solid; font-size:20px;">
<tr><td>Company ID</td><td>			  <input type="text" name="n1" spellcheck="false" placeholder="Company ID" /></td></tr>
<tr><td>Company Name</td><td>			  <input type="text" name="n2" spellcheck="false" placeholder="Company Name" /></td></tr>
...
<tr><td>Company Representative</td><td>			  <input type="text" name="n6" spellcheck="false" placeholder="Company Representative" /></td></tr>

<tr><td>Number of Rounds Conducted</td><td>			  <input type="text" name="n7" spellcheck="false" /></td></tr>
</table>
<br>
