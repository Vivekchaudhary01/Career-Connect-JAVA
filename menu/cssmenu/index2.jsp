...
<ul>
   ...
   <li class='last'><a href='#'><span>Placement Statistics</span></a></li>
...
<div>
<marquee behaviour=scroll direction=left><img src="images/1417159070ims1.jpg" height="300px" width="700px"  /><img src="images/_MG_7470.JPG" height="300px" width="700px"  /><img src="images/DSC_7501.JPG" height="300px" width="700px" /><img src="images/ims_p2.jpg" height="300px" width="700px"  /><img src="images/glory.jpg" height="300px" width="700px" /></marquee>
</div>
...
<br>The institute has set up a comprehensive Career Development Centre offering result oriented services for building commendable careers. The onus of the placement cell is to facilitate and foster a mutually beneficial relationship between the corporations, academia and the students. The college is accredited with Tata Consultancy Services for placement & training projects. The Department has made excellent progress and has been successful in placing majority of the students in reputed companies including TCS, Steria, Samsung, Tech Mahindra, Fiserv, Mankind, R-Systems, IBM, HCL Technologies, NIIT Technologies, Birla Soft, Microsoft, Federal Bank, iGate, Headstrong, Bosch Chassis, Uflex, Syntel, JBM and many more. Among them Microsoft (B.Tech) and Federal Bank (MBA) have offered the highest pay packages. <br>
...
<br>The students of MBA at IMSEC have also been placed in Dubai in Krishna International implying our world’s best academic practices for enhancing employability parameter</h3></b>
</div>
</body>
</html>
